...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					시험 입력<small>시험 입력</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
					<li class="active">시험 입력</li>
				</ol>
			</section>
								...
								<thead>
									<tr>
										...
										<th colspan="2"><input type="text" class="form-control"
											id="searchText" name="searchText" placeholder="반명,시험명 검색"></th>
										<th>시험일</th>
										<th>삭제</th>
									</tr>
								</thead>
	...
	<div class="modal" id="myModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body row" style="min-height: 150px">
					<form id="editFrm">
						...
						<div class="form-group col-sm-12">
							...
							<div class="col-sm-10">
								<input type="hidden" class="form-control" id="exam_id"
									name="exam_id" placeholder="아이디"> <input type="text"
									class="form-control" id="exam_title" name="exam_title"
									placeholder="시험명" required="required">
							</div>
						</div>
						<div class="form-group col-sm-12">
							...
							<div class="col-sm-10">
								<input type="date" class="form-control" id="exam_date"
									name="exam_date" placeholder="exam_date" required="required">
							</div>
						</div>
					</form>
					<div class="form-group col-sm-12">
						<div class="search-table" id="modal-table">
							<div class="col-sm-5">
								<div class="box box-info">
									<table class="table table-hover table-bordered" id="not-surbjects">
										<thead>
											<tr>
	
												<th><a href="javascript:;"
													class="btn btn-default btn-xs" id="not-allCheck">반전하기</a></th>
												<th><input type="text" id="not-search"
													class="form-control input-sm" placeholder="이름검색"></th>
											</tr>
										</thead>
										<tbody>
										</tbody>
							...
							<div class="col-sm-2">
								<button class="btn btn-info btn-xs" id="btnJoin">
									연결 <span class="glyphicon glyphicon-arrow-right"
										aria-hidden="true"></span>
								</button>
								<br />
								<button class="btn btn-warning btn-xs" id="btnCut">
							...
							<div class="col-sm-5">
								<div class="box box-warning">
									<table class="table  table-hover table-bordered " id="con-surbjects">
										<thead>
											<tr>
	
												<th><a href="javascript:;"
													class="btn btn-default btn-xs" id="con-allCheck">반전하기</a></th>
	...
	$(function(){
		...
		$("#searchText").keydown(function(e){
			if(e.which == 13){
				getList($table,$("#searchText").val().toUpperCase());
			}
		});
		...
		function getExamList(){
			$.ajax({
		        ...
		        success: function(json){
					...
					$table.find("tbody").empty().append(conTag);
					clearFrm();
					$('#myModal').modal("hide");
